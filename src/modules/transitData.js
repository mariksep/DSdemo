      ...
      try{
        ...
        let h=document.createElement("h3");
          ...
          for(let i = 0; i<objl; i++){
            ...
            li.innerHTML= data.data.stop.stoptimesWithoutPatterns[i].trip.route.shortName +" "+ data.data.stop.stoptimesWithoutPatterns[i].headsign + " Saapumisaika: " +  arrivalTime ;
            ul.appendChild(li);
          }
